...
public class ApplicationContextPostListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ...
            Map<String, Class<?>> enumShortNameClassMapping = new HashMap<String, Class<?>>();
            ...
            for (Class<?> entityClass : ClassUtils.convertClassNamesToClasses(pui.getManagedClassNames())) {
                ...
                for (Field field : fields) {
                    ...
                    if (fieldClass.isEnum()) {
                        ...
                        String attrName = StringUtils.uncapitalize(fieldClass.getSimpleName()) + "Map";
                        logger.info(" - Put attribute to ServletContext: {} = {}", attrName, enumDataMap);
                        sc.setAttribute(attrName, enumDataMap);
                    }
                }
            }
            ...
            sc.setAttribute("booleanLabelMap", booleanLabelMap);
        } catch (Exception e) {
