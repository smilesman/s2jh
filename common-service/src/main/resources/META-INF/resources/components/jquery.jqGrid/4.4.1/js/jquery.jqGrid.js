...
$.fn.jqFilter = function( arg ) {
	...
	var p = $.extend(true,{
		...
		ops : [
			...
			{"name": "ad", "description": "after date(day)", "operator":">="},
			{"name": "bd", "description": "before date(day)", "operator":"<"},
			{"name": "ed", "description": "equal date(day)", "operator":"="}
		],
		numopts : ['eq','ne', 'lt', 'le', 'gt', 'ge', 'nu', 'nn', 'in', 'ni'],
		stropts : ['eq', 'ne', 'bw', 'bn', 'ew', 'en', 'cn', 'nc', 'nu', 'nn', 'in', 'ni', 'ad', 'bd', 'ed'],
