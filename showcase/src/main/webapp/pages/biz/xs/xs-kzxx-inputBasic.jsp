...
<div class="container-fluid data-edit">
	<s2:form cssClass="form-horizontal" method="post" action="/biz/xs/xs-kzxx!doUpdate">
		...
		<div class="well">
			<div class="row-fluid">
				<div class="span12">
					<s2:radio name="sfjss" list="#application.booleanLabelMap" label="是否寄宿生" />
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<s2:radio name="sfdszn" list="#application.booleanLabelMap" label="是否独生子女" />
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<s2:radio name="sfldrk" list="#application.booleanLabelMap" label="是否流动人口" />
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<s2:radio name="sfsgxqjy" list="#application.booleanLabelMap" label="是否受过学前教育 " />
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
					<s2:radio name="sfsqzn" list="#application.booleanLabelMap" label="是否随迁子女 " />
				</div>
			</div>
			<div class="row-fluid">
				<div class="span12">
