...
<script type="text/javascript">
    $(function() {
            ...
            submitHandler : function(form) {
                $("#xsTransferReqListDiv").grid({
                    ...
                    ondblClickEnabledRow : function(rowid, iRow, iCol, e, rowdata) {
                        $("#xsTransferReqIndexTabs").tabs("add", '${base}/biz/xs/xs-transfer-req!inputTabs?id=' + rowid, "编辑-" + eraseCellValueLink(rowdata['xsJbxx.xh']));
                    },
                    caption : "学生异动列表"
                });
            }
        ...
        $("#xsTransferReqAddBtn").click(function() {
            $("#xsTransferReqIndexTabs").tabs("add", "${base}/biz/xs/xs-transfer-req!inputTabs", "添加-学生异动");
        });
						...
						<div class="toolbar">
							<div class="toolbar-inner">
								...
								<div class="input-prepend">
									...
									<s2:multiselect name="search['IN_state']"
										list="#application.xsTransferReqStateEnumMap" cssClass="input-medium" />
								</div>
