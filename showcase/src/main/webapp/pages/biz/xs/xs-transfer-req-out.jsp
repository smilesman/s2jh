...
<script type="text/javascript">
    $(function() {
        ...
        $("#xsTransferReqSearchForm").formvalidate({
            ...
            submitHandler : function(form) {
                $("#xsTransferReqListDiv").grid({
                    queryForm : $(form),
                    colNames : [ '操作', '学号', '姓名', '性别', '身份证件类型', '身份证件号', '转入学校识别码', '转入学校名称', '申请时间', '最近审批时间', '状态', '创建时间', '版本号' ],
                    colModel : [ {
                        name : 'operation',
                        align : 'center',
                        fixed : true,
                    ...
                    ondblClickEnabledRow : function(rowid, iRow, iCol, e, rowdata) {
                        $("#xsTransferReqIndexTabs").tabs("add", '${base}/biz/xs/xs-transfer-req!forward?_to_=outInputTabs&id=' + rowid, "编辑-" + eraseCellValueLink(rowdata['xsJbxx.xh']));
                    },
                    caption : "学生异动列表"
                });
            }
        ...
        $("#xsTransferReqAddBtn").click(function() {
            $("#xsTransferReqIndexTabs").tabs("add", "${base}/biz/xs/xs-transfer-req!forward?_to_=outInputTabs", "添加-学生异动");
        });
						...
						<div class="toolbar">
							<div class="toolbar-inner">
								...
								<div class="input-prepend">
									...
									<s2:multiselect name="search['IN_state']" list="#application.xsTransferReqStateEnumMap"
										emptyOption="true" cssClass="input-medium" />
								</div>
