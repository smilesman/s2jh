        ...
        <div class="row-fluid">
            <div class="span6">
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <s:property value="#application.booleanLabelMap[sfjss]" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span6">
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <s:property value="#application.booleanLabelMap[sfdszn]" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span6">
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <s:property value="#application.booleanLabelMap[sfldrk]" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span6">
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <s:property value="#application.booleanLabelMap[sfsgxqjy]" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="span6">
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <s:property value="#application.booleanLabelMap[sfsqzn]" />
                    </div>
                </div>
            </div>
        </div>
