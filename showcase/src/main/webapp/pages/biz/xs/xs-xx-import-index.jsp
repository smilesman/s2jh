            ...
            submitHandler : function(form) {
                $("#xsXxImportListDiv").grid({
                    ...
                    ondblClickEnabledRow : function(rowid, iRow, iCol, e, rowdata) {
                        $("#xsXxImportIndexTabs").tabs("add", '${base}/biz/xs/xs-xx-import!inputTabs?id=' + rowid, "编辑-" + eraseCellValueLink(rowdata.displayId));
                    },
                    rowNum : 10,
                    sortorder : "asc",
                    sortname : "lineNum",
						...
						<div class="toolbar">
							<div class="toolbar-inner">
								...
								<div class="input-prepend">
									...
									<s:select name="search['EQ_validatePass']" list="#application.booleanLabelMap"
						...
						<div class="toolbar">
							<div class="toolbar-inner">
								...
								<div class="input-prepend">
									...
									<s:select name="search['EQ_importPass']" list="#application.booleanLabelMap"
