 ...
 * 配置文件在：source/entity_list.properties
 * 生成的代码在：source/generate目录下，其中standalone是一个Entity一个目录，用于偶尔重复生成拷贝某一个Entity相关代码之用，integrate是整合到一起的目录结构
...
public class SourceCodeFrameworkBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String entityName : entityNames) {
            ...
            String integrateRootPath = rootPath + "\\generate\\integrate\\";
            String standaloneRootPath = rootPath + "\\generate\\standalone\\";
            ...
            for (Field field : fields) {
                ...
                if (fieldType == String.class) {
                    ...
                    entityCodeField.setListWidth(80);
                    entityCodeField.setListAlign("center");
                } else if (fieldType == LocalDateTime.class || fieldType == DateTime.class) {
                    entityCodeField = new EntityCodeField();
                    entityCodeField.setListFixed(true);
