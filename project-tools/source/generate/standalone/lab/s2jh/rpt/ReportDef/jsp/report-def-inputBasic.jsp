...
<div class="container-fluid data-edit">
    <s2:form cssClass="form-horizontal" method="post" 
        ...
        <div class="row-fluid">
            <div class="toolbar">
                <div class="toolbar-inner">
                    ...
                    <button type="button" class="btn btn-submit submit-post-close" callback-tab="reportDefIndexTabs"
                        callback-grid="reportDefListDiv">
        ...
        <div class="well">
            ...
            <div class="row-fluid">
                <div class="span6">
                    <s:select name="type" list="#application.reportTypeEnumMap" label="类型"/>
                </div>
            </div>
            <div class="row-fluid">
                <div class="span6">
